...
<div id="main">
  ...
  <div id="opt_area">    
	...
	if(flag){
		window.location("delete_news.jsp?id="+id+"");
	}	
	}
    ...
    <ul class="classlist">
      ...
      if(list==null){
		  ...
		  for(News tempNew:list){
		    n++;		
	     %> 
	      <li><%=tempNew.getNtitle() %><span> 作者：<%=tempNew.getNauthor() %> &#160;&#160;&#160;&#160; <a href='#'>修改</a> &#160;&#160;&#160;&#160; <a href='../newspages/delete_news.jsp?id=<%=tempNew.getNid()%>'>删除</a> </span> </li>
	      <%if(n%5==0){ %>
	      <li class='space'></li>
	      <%}} }%>
    </ul>
