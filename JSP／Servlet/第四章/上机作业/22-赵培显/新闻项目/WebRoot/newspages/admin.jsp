...
<div id="main">
  ...
  <div id="opt_area">    
	...
	function clickdel(nid){
		if( confirm("删除请点击确认"));
		window.location="../util/delete.jsp?opr=delete&nid="+nid;
	}
    ...
    <ul class="classlist">
      ...
      if(list==null){
		  ...
		  for(News tempNew:list){
		    n++;		
	     %> 
	      <li><%=tempNew.getNtitle() %><span> 作者：<%=tempNew.getNauthor() %> &#160;&#160;&#160;&#160; <a href='#'<%response.sendRedirect("../util/xiugai.jsp"); %>>修改</a> &#160;&#160;&#160;&#160; <a href='#' onclick='return clickdel(<%=tempNew.getNid()%>)'>删除</a> </span> </li>
	      <%if(n%5==0){ %>
	      <li class='space'></li>
	      <%}} }%>
    </ul>
