	...
	<FORM action="infos.jsp" method="post" name="myform">
		<TABLE border="0" cellpadding="0" cellspacing="0" align="center"
			...
			<TR>
				...
				<TD width="524"><INPUT name="txtUser" type="text"
					maxlength="16">只能输入字母或数字，4-16个字符</TD>
			</TR>
			<TR>
			...
			<TR>
				...
				<TD width="524"><INPUT name="gen" type="radio" value="男"
					checked>男&nbsp; <INPUT name="gen" type="radio" value="女"
					class="input">女</TD>
			</TR>
			<TR>
			...
			<TR>
				...
				<TD width="524"><INPUT name="year" id="year" size="4"
					maxlength="4">&nbsp;年&nbsp;&nbsp; <SELECT name="month">
			...
			<TR>
				<TD colspan="2" align="center"><INPUT type="submit"
					value="同意以下协议条款并提交"></TD>
			</TR>
			<TR>
				<TD colspan="2"><TEXTAREA cols="" rows="" readonly="readonly"
						style="width:480px;height:110px;font-size:12px;color:#666">
一、总则
