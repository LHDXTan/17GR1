$(document).ready(function() {
	...
	$("#shopping_commend_arrow").click(function() {
		if($(this).click(".shopping_commend_sort").css("display") == "none") {
	...
	//偶数行变色
	$("#myTableProduct").find("tr:odd").css("background-color", "bisque");
	  //计算总价
    function totalPrice(){
	...
	$("#myTableProduct").find(".shopping_product_list_5").children("input").change(function(){
		var value=$(this).val();
		if ((value=="")||!(/^[0-9]*[1-9][09]*$/.test(value))) {
	...
	$("#removeAllProduct").click(function(){
		...
		$(".shopping_list_border").append("<div class='empty_product'><div>您还没挑选商品，<a href='index.html'>去挑选看看</a></div></div>")
	})
