...
public class TestServerlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		request.setAttribute("nicheng",nicheng);
		request.setAttribute("chengshi",chengshi);
		request.setAttribute("yuyan",yuyan);
		HttpSession session = request.getSession();
		session.setAttribute("nicheng", nicheng);
		session.setAttribute("chengshi", chengshi);
		session.setAttribute("yuyan", yuyan);
