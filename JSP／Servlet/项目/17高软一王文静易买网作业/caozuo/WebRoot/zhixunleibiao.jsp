...
<UL>
  ...
  href="">用户信息</A></LI>
  <LI><A 
  href="">用户列表</A></LI></UL></DIV>
<DIV class="left_m">
<DIV class="left_m_t t_bg2">商品管理</DIV>
<UL>
  <LI><A 
  href="">分类管理</A></LI>
  <LI><A href="http://localhost:8082/caozuo/product.jsp">商品管理</A></LI>
  <LI><A 
  href="">商品上架</A></LI></UL></DIV>
<DIV class="left_m">
<DIV class="left_m_t t_bg2">资讯中心</DIV>
<UL>
  <LI><A 
  href="http://localhost:8082/caozuo/zhixunleibiao.jsp"style="color:#ff4e00;">资讯列表</A></LI></UL></DIV></DIV>
<DIV class="m_right" id="content">
<DIV class="mem_tit">资讯列表</DIV>
<form action="newsDaoimpServle" method="post">
