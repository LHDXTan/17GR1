    ...
    <div class="content mar_20">
        ...
        <div class="l_list">
            ...
            <script type="text/javascript">
		        	...
		        	function shanglist(){
		        		$.getJSON("ProductServlet","action=selectshot&id=<%=request.getParameter("a")%>",function(jsonString){
		        			$(".postion").remove();
		        			$(".l_history").remove();
		        			$(jsonString).each(function(){
		        				$(".cate_list").append("<li>"
		                            	+"<div class='img'><a href='Product.jsp?id="+this.id+"'><img src='"+this.fileName+"' width='210' height='185'/></a></div>"
		                                +"<div class='price'>"
		                              	+"  <font>￥<span>"+this.price+"</span></font> &nbsp; 26R"
		                                +"</div>"
		                                +"<div class='name'><a href='Product.jsp?id="+this.id+"'>"+this.name+"</a></div>"
		                                +"<div class='carbg'>"
		                                +"<a href='#' class='ss'>收藏</a>"
		                                +"<a onclick='gouwu("+this.id+")' class='j_car'>加入购物车</a>"
		                                +"</div>"
		                            	+"</li>");
		        			});
		        		});
		        	...
		        	function gouwu(id){
		        		$.getJSON("ProductServlet","action=add&id="+id,function(jsonString){
		        			alert(jsonString);
		        		});
		        	}
       		 </script>
                ...
                <div class="pages">
                	<a href="#" class="p_pre">上一页</a><a href="#" class="cur">1</a><a href="#" onclick="">2</a><a href="#">3</a>...<a href="#">20</a><a href="#" class="p_pre">下一页</a>
                </div>
            </div>
        </div>
    </div>
