...
<div class="i_bg">
    ...
    <!-- postion-content mar_20,删除div  content循环 -->
    <div class="content">
        ...
        <script type="text/javascript">
		    	...
		    	function sell(){
			    	$.getJSON("ProductServlet","action=sellist&id=<%=request.getParameter("id")%>",function(jsonString){
			    		$(".mar_20").remove();
			    		$(jsonString).each(function(){
			    			$("#tsImgS>a").attr("href",this.fileName).children("img").attr("src",this.fileName);
			    			$(".des_name").append("<p>"+this.name+"</p>“开业巨惠，北京专柜直供”，不光低价，“真”才靠谱！");
			    			$(".des_price").append("本店价格：<b>"+this.price+"</b><br />消费积分：<span>28R</span>");
			    		});
			    	});
		    	}
		    	
		    	function sdk(){
		    		var c = $(".n_ipt").val();//商品数量。
		    		alert(c);
		    		$.getJSON("ProductServlet","action=add&id=<%=request.getParameter("id")%>",function(jsonString){
		    			alert(jsonString);
			    	});
		    	}
    		</script>
        ...
        <div class="pro_des">
            ...
            <div class="des_join">
                ...
                <span class="fl"><a onclick="sdk()"><img src="images/j_car.png" /></a></span>
            </div>            
        </div>    
