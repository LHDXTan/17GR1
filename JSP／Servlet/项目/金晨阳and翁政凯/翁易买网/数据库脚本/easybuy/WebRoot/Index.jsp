...
<%@ page import="com.qhit.entity.*,com.qhit.util.*,com.qhit.server.imp.ProductServerImp"%>
<%
            ...
            <div class="leftNav">
                <ul>      
                  ...
                  <script type="text/javascript">
	                  	...
	                  	function shot(){
	                  		$.getJSON("ProductServlet","action=slectvo",function(jsonString){
	                  			$(jsonString).each(function(i,n){
	                  				$(".kl"+i).append("<div class='fj'>"
	                  						+"<span class='n_img'><span></span><img src='images/nav"+(i+1)+".png'/></span>"
	                  						+"<span class='fl'>"+n.ProductCategory.name+"</span>"+"</div>");
	                  				$(this.ProductCategoryVoList).each(function(){
	                  					$(".jk"+i).append("/"+this.ProductCategory.name);
	                  					$(this.ProductCategoryVoList).each(function(){
	                      					$(".zj_l_c").append("<a href='BrandList.jsp?a="+this.ProductCategory.id+"'>"+this.ProductCategory.name+"</a>|");
	                      				});
	                  				});
	                  			});
	                  		});
	                  	...
	                  	function news(){
	                  		$.getJSON("ProductServlet","action=selectnews",function(jsonString){
	                  			$(jsonString).each(function(){
	                  				$(".uld").append("<li><span>["+this.title+"]</span><a href='#'>"+this.content+"</a></li>");
	                  			});
	                  		});
	                  	}
                </script>
