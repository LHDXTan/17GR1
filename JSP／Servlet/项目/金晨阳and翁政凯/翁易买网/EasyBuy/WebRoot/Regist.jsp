...
<div class="log_bg">	
	...
	<div class="regist">
		...
		<div class="reg_c">
        	...
        	<form method="post" action="UserServlet?action=inseruser" >
            <table border="0" style="width:420px; font-size:14px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;登陆用户名 &nbsp;</td>
                <td><input type="text" class="l_user" name="loginName" /></td>
              </tr>
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;密码 &nbsp;</td>
                <td><input type="password" class="l_pwd" name="pwd" /></td>
              </tr>
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>&nbsp;确认密码 &nbsp;</td>
                <td><input type="password" class="l_pwd" name="ped" /></td>
              </tr>
              <tr height="50">
                <td align="right"><font color="#ff4e00">*</font>真实姓名 &nbsp;</td>
                <td><input type="text" class="l_mem" name="username"/></td>
              </tr>
              <tr height="50">
              ...
              <tr height="50">
                ...
                <td><input type="text" class="l_num" name="identityCode"/></td>
              </tr>
              
              <tr height="50">
                <td align="right">&nbsp;邮箱 &nbsp;</td>
                <td><input type="text" class="l_email" name="email"/></td>
              </tr>
              <tr height="50">
