...
public class UserServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(parameter.equals("deteleuser")){ //注销
		...
		}else if(parameter.equals("updateshangpin")){//商品的修改
			response.sendRedirect("Member_Money.jsp");
			System.out.println("dsajkhdjaskhdaskjsd");
			...
			List<Product> selectId_ProductDao = pi.selectId_ProductDao(id);
			request.getSession().setAttribute("product", selectId_ProductDao);
			response.sendRedirect("Member_Money.jsp");
		}
	}
