...
onclick="CloseDiv_1('MyDiv1','fade1')"><IMG src="user_files/close.gif"></SPAN>   
  </DIV>
<DIV class="notice_c">
<TABLE align="center" border="0" cellspacing="0" cellpadding="0">
  <TBODY>
  <TR valign="top">
    <TD width="40"><IMG src="user_files/suc.png"></TD>
...
href="user_files/style.css" rel="stylesheet" type="text/css"> 
<SCRIPT src="user_files/jquery-1.11.1.min_044d0927.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/jquery.bxslider_e88acd1b.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/jquery-1.8.2.min.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/menu.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/select.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/lrscroll.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/iban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/fban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/f_ban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/mban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/bban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/hban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/tban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/lrscroll_1.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/register.js" type="text/javascript"></SCRIPT>
 <LINK href="user_files/ShopShow.css" rel="stylesheet" type="text/css"> <LINK 
href="user_files/MagicZoom.css" rel="stylesheet" type="text/css"> 
<SCRIPT src="user_files/MagicZoom.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/num.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/p_tab.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="user_files/shade.js" type="text/javascript"></SCRIPT>
     
<SCRIPT src="user_files/backend.js"></SCRIPT>
...
<DIV class="m_des">
<TABLE style="width: 870px; line-height: 22px;" border="0" cellspacing="0" 
cellpadding="0">
  <TBODY>
  <TR valign="top">
    <TD width="115"><IMG width="90" height="90" src="images\user.jpg"></TD>
    <TD>
      <DIV class="m_user">${user.loginName}</DIV><BR>
      <P>                                性别:                                     
      ...
      邮箱:${user.email}<BR><BR>电话:${user.mobile }<BR><BR></P></TD></TR></TBODY></TABLE></DIV></DIV> 
    </DIV>
