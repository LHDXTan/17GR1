...
<script type="text/javascript">
	<%--   $.get({
		...
		alert("请先登录");
		window.location.href="<%=paths%>/login.jsp";  
		<%}else{%>
		  alert("欢迎"+user +"登陆");
		<%}%> --%>
		/* <li><div class="fj">
			<span class="n_img"><span></span><img src="images/nav2.png" /></span> <span class="fl">食品、饮料、酒</span>
		</div>
		<div class="zj" style="top:-40px;"><div class="zj_l"><div class="zj_l_c">
					<h2>零食 / 糖果 / 巧克力2</h2>
		...
		/*  <li>
			...
			<div class="zj" style="top:-40px;">
				...
				<div class="zj_r"><a href="#"><img src="images/n_img1.jpg" width="236"height="200" /></a> <a href="#"><img src="images/n_img2.jpg" width="236" height="200" /></a></div>
			</div>
		</li>  */
		//三级列表
	  $(function (){
		$.get({
			...
			"success":function(str){
				alert(str);
				$("div[class='leftNav none']>ul").empty();
				var data =$.parseJSON(str);
				//一级列表
				$(data).each(function(i,n){
					$("div[class='leftNav none']>ul").append("<li class='"+i+"'><div class='fj'></div></li>");
					$("div[class='leftNav none']>ul>."+i+">.fj").append("<span class='n_img'><span></span><img src='images/nav2.png' /></span> <span class='fl'>"+this.productCategory.name+"</span>");
					$("div[class='leftNav none']>ul>."+i+"").append("<div class='zj' style='top:-40px;'></div>")
					$("div[class='leftNav none']>ul>."+i+">.zj").append("<div class='zj_l'></div>");
					//alert(this.productCategory.name);
					//二级列表
					$(this.productCategoryVoList).each(function (){
						$("div[class='leftNav none']>ul>."+i+">.zj>.zj_l").append("<div class='zj_l_c'><h2>"+this.productCategory.name+"</h2></div>");
						//$("div[class='leftNav none']>ul>."+i+">.zj>.zj_l>.zj_l_c").append("<h2>"+this.productCategory.name+"</h2>");
						//alert(this.productCategory.name);
						//三级列表
						$(this.productCategoryVoList).each(function (){
							$("div[class='leftNav none']>ul>."+i+">.zj>.zj_l>.zj_l_c").append("<a href='#'>"+this.productCategory.name+"</a>|");
							//alert(this.productCategory.name);
						});
					});
					
						$("div[class='leftNav none']>ul>."+i+">.zj").append("</div><div class='zj_r'><a href='#'><img src='images/n_img1.jpg' width='236' height='200' /></a> <a href='#'><img src='images/n_img2.jpg' width='236' height='200' /></a></div>")
				});
				
				//$("#leftNav").trigger("create");
				
				$("div[class='leftNav none']>ul li").hover(
						function(){
...
<body >
	...
	<div class="soubg">
		<div class="sou">
			...
			<c:if test="${empty userName}">
			<a href="login.jsp">请 登录</a>
			&nbsp; <a href="regist.jsp"
					style="color:#ff4e00;">免费注册</a>&nbsp;
			</c:if>
			<c:if test="${!empty userName}">
			  ${userName} &nbsp;欢迎登陆
			  &nbsp; <a href="<%=path%>/indexAction?org=zhuxiao"
					style="color:#ff4e00;">注销</a>&nbsp;
			</c:if>
			|&nbsp;<a href="#">我的订单</a>&nbsp;|
			...
			<div class="l_list">
				...
				<div class="list_c">
					...
					<ul class="brand">
						<li>
							<div class="img">
								<img src="images/brand1.jpg" width="226" height="108" />
							</div>
							<div class="name">
								<span>普拉达</span>（20）
							</div>
						...
						<li>
							<div class="img">
								<img src="images/brand2.jpg" width="226" height="108" />
							</div>
							<div class="name">
								<span>劳力士</span>（20）
							</div>
						...
						<li>
							<div class="img">
								<img src="images/brand3.jpg" width="226" height="108" />
							</div>
							<div class="name">
								<span>古奇</span>（20）
							</div>
						...
						<li>
							<div class="img">
								<img src="images/brand4.jpg" width="226" height="108" />
							</div>
							<div class="name">
								<span>迪奥</span>（20）
							</div>
