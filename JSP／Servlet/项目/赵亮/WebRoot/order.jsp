...
href="<%=path%>/ProductAction?org=selectMyDian">我的订单</A>&nbsp;</SPAN> 
...
onclick="CloseDiv_1('MyDiv1','fade1')"><IMG src="order_files/close.gif"></SPAN>  
   </DIV>
<DIV class="notice_c">
<TABLE align="center" border="0" cellspacing="0" cellpadding="0">
  <TBODY>
  <TR valign="top">
    <TD width="40"><IMG src="order_files/suc.png"></TD>
...
href="order_files/style.css" rel="stylesheet" type="text/css"> 
<SCRIPT src="order_files/jquery-1.11.1.min_044d0927.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/jquery.bxslider_e88acd1b.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/jquery-1.8.2.min.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/menu.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/select.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/lrscroll.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/iban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/fban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/f_ban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/mban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/bban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/hban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/tban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/lrscroll_1.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/register.js" type="text/javascript"></SCRIPT>
 <LINK href="order_files/ShopShow.css" rel="stylesheet" type="text/css"> <LINK 
href="order_files/MagicZoom.css" rel="stylesheet" type="text/css"> 
<SCRIPT src="order_files/MagicZoom.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/num.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/p_tab.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="order_files/shade.js" type="text/javascript"></SCRIPT>
   
<SCRIPT src="order_files/backend.js"></SCRIPT>
...
<!-- 全部订单 -->
<c:if test="${not empty PageOrderList}">
	<c:forEach items="${listOrder.list}" var="DianDan">
		 <TBODY>
  <TR class="td_bg">
    <TD>用户名:${DianDan.order.loginName}</TD>
    <TD><A href="http://localhost:8082/EasyBuy/admin/order?action=queryOrderDeatil&amp;orderId=4">订单号:${DianDan.order.serialNumber}</A></TD>
    <TD>地址:${DianDan.order.userAddress}</TD>
    <TD>￥${DianDan.order.cost}</TD></TR>
  <TR></TR>
	    <TD colspan="4">
			      <TABLE class="order_tab" style="width: 930px; text-align: center; margin-bottom: 30px;" 
			      border="0" cellspacing="0" cellpadding="0">
			        ...
			        <TR>
			          ...
			          <TD width="20%">商品图片</TD>
			          <TD width="25%">数量</TD>
			          <TD width="25%">价格</TD></TR>
 			<c:forEach items="${DianDan.list}" var="proDate">
 				 <TR>
			        <TR>
			          <TD>${proDate.name}</TD>
			          <TD><A href="http://localhost:8082/EasyBuy/Product?action=queryProductDeatil&amp;id=733" 
			            target="_blank"><IMG width="50" height="50" src="${proDate.filename}"> 
			                                  </A>                     </TD>
			          <TD>${proDate.count}</TD>
			          <TD>${proDate.price}</TD>
			       </TR>
							    ...
							    <TD colspan="4">
									      ...
									      border="0" cellspacing="0" cellpadding="0">
									        ...
									        <TR>
									          ...
									          <TD width="25%">数量</TD>
									          <TD width="25%">价格</TD></TR>
			 		<c:forEach items="${DianDan.list}" var="proDeta">
									        <TR>
									          <TD>${proDeta.name}</TD>
									          <TD><A href="http://localhost:8082/EasyBuy/Product?action=queryProductDeatil&amp;id=733" 
									            target="_blank"><IMG width="50" height="50" src="${proDeta.filename}"> 
									                                  </A>                     </TD>
									          <TD>${proDeta.count}</TD>
									          <TD>${proDeta.price}</TD></TR>
			 		</c:forEach>
									          </TBODY>
									   </TABLE>
							  		</TD>
...
<SCRIPT type="text/javascript">
 ...
 <c:if test="${empty PageOrderList}">
<DIV class="pages">
<A class="p_pre" href="<%=path%>/ProductAction?org=selectMyDian">首页</A> 
<A class="cur" href="<%=path%>/ProductAction?org=selectMyDian&index=0">1</A> 
   <A href="<%=path%>/ProductAction?org=selectMyDian&index=${listOrder.index+1}">下一页</A> 
 <A href="<%=path%>/ProductAction?org=selectMyDian&index=${listOrder.zongye-1}">尾页</A> 
        </DIV>
        
 </c:if>
 <c:if test="${not empty PageOrderList}">
<DIV class="pages">
<A class="p_pre" href="<%=path%>/ProductAction?org=selectDetailAll">首页</A> 
<A class="cur" href="<%=path%>/ProductAction?org=selectDetailAll&index=0">1</A> 
   <A href="<%=path%>/ProductAction?org=selectDetailAll&index=${listOrder.index+1}">下一页</A> 
 <A href="<%=path%>/ProductAction?org=selectDetailAll&index=${listOrder.zongye-1}">尾页</A> 
        </DIV>
