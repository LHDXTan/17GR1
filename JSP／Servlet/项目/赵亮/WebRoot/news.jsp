...
onclick="CloseDiv_1('MyDiv1','fade1')"><IMG src="news_files/close.gif"></SPAN>   
  </DIV>
<DIV class="notice_c">
<TABLE align="center" border="0" cellspacing="0" cellpadding="0">
  <TBODY>
  <TR valign="top">
    <TD width="40"><IMG src="news_files/suc.png"></TD>
...
href="news_files/style.css" rel="stylesheet" type="text/css"> 
<SCRIPT src="news_files/jquery-1.11.1.min_044d0927.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/jquery.bxslider_e88acd1b.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/jquery-1.8.2.min.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/menu.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/select.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/lrscroll.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/iban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/fban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/f_ban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/mban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/bban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/hban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/tban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/lrscroll_1.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/register.js" type="text/javascript"></SCRIPT>
 <LINK href="news_files/ShopShow.css" rel="stylesheet" type="text/css"> <LINK 
href="news_files/MagicZoom.css" rel="stylesheet" type="text/css"> 
<SCRIPT src="news_files/MagicZoom.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/num.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/p_tab.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="news_files/shade.js" type="text/javascript"></SCRIPT>
     <LINK href="news_files/style.css" rel="stylesheet" type="text/css"> 
<SCRIPT type="text/javascript">
...
border="0" cellspacing="0" cellpadding="0">
  ...
  <TR>
    <TD width="20%">文章标题</TD>
    <TD width="25%">创建时间</TD></TR>
    <c:forEach items="${pageNewList.list}" var="news">
  <TR>
    <TD><A href="http://localhost:8082/EasyBuy/admin/news?action=newsDeatil&amp;id=531">${news.title}</A></TD>
...
<DIV class="pages">
<A class="p_pre" href="<%=path%>/ProductAction?org=selectNewList">首页</A> 
<A class="cur" href="<%=path%>/ProductAction?org=selectNewList&index=0">1</A> 
               
   <A href="<%=path%>/ProductAction?org=selectNewList&index=${pageNewList.index+1}">下一页</A> 
 <A href="<%=path%>/ProductAction?org=selectNewList&index=${pageNewList.zongye-1}">尾页</A> 
        </DIV>
