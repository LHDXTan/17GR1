...
<script type="text/javascript">
	function deleteById(id) {
	  ...
	  function deleteUserId(id){
	    	alert(id);
			window.location.href="<%=path%>/ProductAction?org=deleteUser&id="+id;
	    	return false;
	    }
...
<P align="right"><A class="add_b" href="http://localhost:8082/EasyBuy/admin/user?action=toAddUser">添加用户</A> 
                <BR></P><BR>
...
border="0" cellspacing="0" cellpadding="0">
  ...
  <TR>
    ...
    <A href="http://localhost:8082/EasyBuy/admin/user?action=toUpdateUser&amp;id=${user.id}">修改</A> 
                           </c:if>                                               
                            
       <c:if test="${my==user.id}">
    ...
    <A onclick="deleteUserId('${user.id}');" href="javascript:void(0);" target="_blank">删除</A> 
                           </c:if>  
                             	                         </TD>
...
<DIV class="pages"><A class="p_pre" href="http://localhost:8082/EasyBuy//admin/user?action=queryUserList&amp;currentPage=1">首页</A> 
                                            <A class="cur" href="http://localhost:8082/EasyBuy//admin/user?action=queryUserList&amp;currentPage=1">1</A> 
                                                                        <A href="http://localhost:8082/EasyBuy//admin/user?action=queryUserList&amp;currentPage=2">2</A> 
                                   <A class="p_pre" href="http://localhost:8082/EasyBuy//admin/user?action=queryUserList&amp;currentPage=2">下一页</A> 
            <A class="p_pre" href="http://localhost:8082/EasyBuy//admin/user?action=queryUserList&amp;currentPage=2">尾页</A> 
        </DIV></DIV>     </DIV>
