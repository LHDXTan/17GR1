...
<!-- saved from url=(0064)http://localhost:8082/EasyBuy/admin/productCategory -->
...
onclick="CloseDiv_1('MyDiv1','fade1')"><IMG src="productCategory_files/close.gif"></SPAN> 
    </DIV>
<DIV class="notice_c">
<TABLE align="center" border="0" cellspacing="0" cellpadding="0">
  <TBODY>
  <TR valign="top">
    <TD width="40"><IMG src="productCategory_files/suc.png"></TD>
...
href="productCategory_files/style.css" rel="stylesheet" type="text/css"> 
<SCRIPT src="productCategory_files/jquery-1.11.1.min_044d0927.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/jquery.bxslider_e88acd1b.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/jquery-1.8.2.min.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/menu.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/select.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/lrscroll.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/iban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/fban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/f_ban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/mban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/bban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/hban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/tban.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/lrscroll_1.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/register.js" type="text/javascript"></SCRIPT>
 <LINK href="productCategory_files/ShopShow.css" rel="stylesheet" type="text/css"> 
<LINK href="productCategory_files/MagicZoom.css" rel="stylesheet" type="text/css"> 
<SCRIPT src="productCategory_files/MagicZoom.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/num.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/p_tab.js" type="text/javascript"></SCRIPT>
 
<SCRIPT src="productCategory_files/shade.js" type="text/javascript"></SCRIPT>
   
<SCRIPT src="productCategory_files/backend.js"></SCRIPT>
...
<P align="right"><A class="add_b" onclick="toAddProductCategory();" href="javascript:void(0);">添加分类</A> 
        <BR></P><BR>
...
border="0" cellspacing="0" cellpadding="0">
  ...
  <TR>
    ...
    <TD width="25%">分类级别</TD>
    <TD width="25%">父级分类</TD>
    <TD width="25%">操作</TD></TR>
    <c:forEach items="${pageProductCategpryLimit.list}" var="pageProductCategpry">
  <TR>
    <TD width="5%"><INPUT name="select" onclick="toUpdateProductCategoryList(this);" 
      type="radio" value="548"></TD>
    <TD>${pageProductCategpry.name}</TD>
    <TD>                           
    			<c:if test="${pageProductCategpry.type==1}">
    			
    			一级分类                                        
    			</c:if>
    			<c:if test="${pageProductCategpry.type==2}">
				二级分类    			
    			</c:if>
    			<c:if test="${pageProductCategpry.type==3}">
    			三级分类
    			</c:if>
    			
    </TD>
    <TD>                        	                                
    			<c:if test="${pageProductCategpry.parentld !=0}">
    						有
    ...
    <TD>
    			<c:if test="${pageProductCategpry.type==3}">
    			<A onclick="deleteProductCategory(548,1);" 
...
<DIV class="pages">
<A class="p_pre" href="<%=path%>/ProductAction?org=selectProductCategory">首页</A> 
<A class="cur" href="<%=path%>/ProductAction?org=selectProductCategory&index=0">1</A> 
   <A href="<%=path%>/ProductAction?org=selectProductCategory&index=${pageProductCategpryLimit.index+1}">下一页</A> 
 <A href="<%=path%>/ProductAction?org=selectProductCategory&index=${pageProductCategpryLimit.zongye}">尾页</A> 
 </DIV>
<DIV id="addProductCategory"></DIV></DIV>   </DIV>
