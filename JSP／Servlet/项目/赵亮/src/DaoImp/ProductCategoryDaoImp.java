...
public class ProductCategoryDaoImp extends BaseDao implements ProductCategoryDao{
	...
	@Override
	public List<ProductCategory> getProductCategpryLimit(PageU page) {
		String sql="select * from product_category limit ?,?";
	...
	public int getProductCategpryCount() {
		String sql="select * from product_category where id is not null";
		int count=0;
