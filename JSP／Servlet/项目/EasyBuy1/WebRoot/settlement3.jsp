...
<div class="content mar_20">
    <img src="images/images/img3.jpg"/>
</div>
<div class="content mar_20">
    <!--Begin 银行卡支付 Begin -->
    <div class="warning">
        <table  style="width:1000px; text-align:center;" >
            ...
            <tr>
                <td style="font-size:14px; font-family:'宋体'; padding:10px 0 20px 0; border-bottom:1px solid #b6b6b6;">
                    您选定的配送方式为: <font color="#ff4e00">申通快递</font>； &nbsp; &nbsp;您选定的支付方式为: <font color="#ff4e00">支付宝</font>； &nbsp; &nbsp;您的应付款金额为: <font color="#ff4e00">￥${currentOrder.cost}</font>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    <a href="Index?action=index">首页</a> &nbsp; &nbsp; <a href="Index?action=index">用户中心</a>
                </td>
            </tr>
        </table>
    </div>
