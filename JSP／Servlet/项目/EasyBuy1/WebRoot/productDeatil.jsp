...
<script type="text/javascript" src="js/publicFiles/n_nav.js"></script>
...
<body>
	...
	<div class="menu_bg">
		<div class="menu">
			<!--Begin 商品分类详情 Begin-->
			<%@ include file="/publicFiles/pre/categoryBar.jsp"%>
			<!--End 商品分类详情 End-->
		</div>
	</div>
	<!--End Menu End-->
	<div class="i_bg">
		...
		<div class="content">
			<div id="tsShopContainer">
				<div id="tsImgS">
					<a href="images/${product.fileName}" title="Images"
						class="MagicZoom" id="MagicZoom"> <img
						src="images/${product.fileName}" width="390" height="390" />
					</a>
				</div>
			</div>
			<div class="pro_des">
				...
				<div class="des_join">
					<div class="j_nums">
						<input type="text" value="1" name="quantity" class="n_ipt" /> <input
							type="button" value="" onclick="addUpdate(jq(this));"
							class="n_btn_1" /> <input type="button" value=""
							onclick="jianUpdate(jq(this));" class="n_btn_2" /> <input
							type="hidden" name="productStock" value="${product.stock}" />
					</div>
					<span class="fl"> <img src="images/images/j_car.png"
						onclick="addCart();" />
					</span>
				</div>
			</div>
