	...
	<div class="i_bg bg_color">
		...
		<div class="m_content">
			...
			<div class="m_right" id="content">
				...
				<br></br>
				<form action="admin/user?action=updateUser" method="post"
					id="userAdd" onsubmit="return checkUser();">
					<table border="0" class="add_tab" style="width:930px;"
						cellspacing="0" cellpadding="0">
						<tr>
							<td width="135" align="right">用户姓名</td>
							<td colspan="3" style="font-family:'宋体';"><input type="text"
								value="${user.loginName}" class="add_ipt" name="loginName" /> <input
								type="hidden" value="${user.id}" name="id" /></td>
						</tr>
						<tr>
							<td width="135" align="right">真实姓名</td>
							<td><input type="text" value="${user.userName}"
								class="add_ipt" name="userName" /></td>
						</tr>
						...
						<tr>
							...
							<td><input type="text" value="${user.identityCode}"
								class="add_ipt" name="identityCode" id="identityCode" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" value="${user.mobile}"
								class="add_ipt" name="mobile" id="mobile" /></td>
						</tr>
						<tr>
							...
							<td><select name="type">
									...
									<option value="0"
										<c:if test="${user.type==0}">selected="selected"</c:if>>普通用户</option>
							</select></td>
						</tr>
						<tr>
							<td></td>
