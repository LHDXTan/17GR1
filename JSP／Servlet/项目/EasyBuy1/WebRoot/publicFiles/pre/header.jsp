...
<div class="soubg">
	<div class="sou">
		...
		<!--End 所在收货地区 End-->
		<span class="fr"> <c:if test="${sessionScope.loginUser==null}">
				<span class="fl">你好，请<a href="${ctx}/Login?action=toLogin"
					style="color:#ff4e00;">登录</a>&nbsp;<a
					href="${ctx}/Register?action=toRegister" style="color:#ff4e00;">免费注册</a>&nbsp;&nbsp;
				</span>
				...
				test="${sessionScope.loginUser!=null && sessionScope.loginUser.type==1}">
				<span class="fl">|&nbsp;<a
					href="${ctx}/admin/product?action=index&userId=${sessionScope.loginUser.id}">后台管理</a>&nbsp;
				</span>
			</c:if> <c:if test="${sessionScope.loginUser!=null}">
				<span class="fl">|&nbsp;<a
					href="${ctx}/Login?action=loginOut">注销</a></span>
			</c:if>
		</span>
	</div>
</div>
	...
	<div class="white_d">
		...
		<div class="notice_c">
			<table style="align:center">
				<tr style="valign:top">
					<td style="width:40"><img src="${ctx}/statics/images/suc.png"></td>
					<td><span
...
<script type="text/javascript"
	src="${ctx}/statics/js/common/jquery-1.11.1.min_044d0927.js"></script>
<script type="text/javascript"
	src="${ctx}/statics/js/common/jquery.bxslider_e88acd1b.js"></script>
<script type="text/javascript"
...
<script type="text/javascript"
	src="${ctx}/statics/js/common/lrscroll.js"></script>
...
<script type="text/javascript"
	src="${ctx}/statics/js/common/lrscroll_1.js"></script>

<script type="text/javascript"
	src="${ctx}/statics/js/register/register.js"></script>
<link rel="stylesheet" type="text/css"
	href="${ctx}/statics/css/ShopShow.css" />
<link rel="stylesheet" type="text/css"
	href="${ctx}/statics/css/MagicZoom.css" />
<script type="text/javascript"
	src="${ctx}/statics/js/common/MagicZoom.js"></script>
