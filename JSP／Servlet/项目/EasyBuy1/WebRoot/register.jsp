...
<body>
	...
	<div class="log_bg">
		<div class="top">
			<div class="logo">
				<a href="Index?action=index"><img
					src="images/images/logo.png" /></a>
			</div>
		</div>
		<div class="regist">
			<div class="log_img">
				<img src="images/images/l_img.png" width="611" height="425" />
			</div>
			<div class="reg_c">
				<form id="register">
					<table border="0"
						...
						<tr style="height:50" valign="top">
							...
							<td><span class="fl" style="font-size:24px;">注册</span> <span
								class="fr">已有商城账号，<a href="Login?action=toLogin"
									style="color:#ff4e00;">我要登录</a></span></td>
						</tr>
						<tr style="height:50">
							<td align="right"><font color="#ff4e00">*</font>登录用户名 &nbsp;</td>
							<td><input type="text" value="" name="loginName"
								class="l_user" /></td>
						</tr>
						<tr style="height:50">
						...
						<tr style="height:50">
							<td align="right"><font color="#ff4e00">*</font>&nbsp;性别
								&nbsp;</td>
	...
	<div class="btmbg">
		<div class="btm">
			...
			<img src="images/images/b_1.gif" width="98" height="33" /><img
				src="images/images/b_2.gif" width="98" height="33" /><img
				src="images/images/b_3.gif" width="98" height="33" /><img
				src="images/images/b_4.gif" width="98" height="33" /><img
				src="images/images/b_5.gif" width="98" height="33" /><img
				src="images/images/b_6.gif" width="98" height="33" />
		</div>
	</div>
	<!--End Footer End -->
</body>
