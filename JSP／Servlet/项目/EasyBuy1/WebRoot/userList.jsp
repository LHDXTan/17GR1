	...
	<div class="i_bg bg_color">
		...
		<div class="m_content">
			...
			<div class="m_right" id="content">
				...
				<p align="right">
					<a href="admin/user?action=toAddUser" class="add_b">添加用户</a>
					<br></br>
				</p>
				<br></br>
					...
					<tbody>
						...
						<c:forEach items="${userList}" var="temp">
							<tr>
								...
								<td><a
									href="admin/user?action=toUpdateUser&id=${temp.id}">修改</a>
								</td>
								<td><c:if test="${sessionScope.loginUser.id!=temp.id}">
										<a href="javascript:void(0);"
											onclick="deleteUserId('${temp.id}');" target="_blank">删除</a>
									</c:if></td>
							</tr>
						</c:forEach>
					</tbody>
