...
public class AdminProductServlet extends HttpServlet {
	...
	private static final long serialVersionUID = 5389662387873297914L;
	...
	public String index(HttpServletRequest request, HttpServletResponse response)
		...
		int rowPerPage = EmptyUtils.isEmpty(pageSize) ? 5 : Integer
				.parseInt(pageSize);
	...
	public void addProduct(HttpServletRequest request,
		...
		try {
			...
			if (EmptyUtils.isEmpty(id) || id.equals("0")) {
				...
				if (EmptyUtils.isEmpty(product.getFileName())
						|| product.getFileName().length() < 5) {
