...
$(function($){
    ...
    function bookList(){
        ...
        $.each(catalog,function(i,n){
            html+="<div class='product_storyList_content_left'><img src=img/"+n[0]+" alt='图书列表'></div>";
            ...
            for(var k=0;k<5;k++){
                if(k<n[2]){
                    html+= "<img src='img/star_red.gif' alt='star'>";
                }
                else{
                    html+= "<img src='img/star_gray.gif' alt='star'>";
                }
            }
            html+="</li>";
            ...
            html+="<dd><img src='img/product_buy_02.gif' alt='shopping'></dd>";
            html+="<dd><img src='img/product_buy_01.gif' alt='shopping'></dd>";
            html+="<dd>节省："+n[7]+"</dd>";
