...
$(document).ready(function(){
    ...
    $("#registerBtn").click(function(){
        ...
        if(repwd.validity.valueMissing==true){
            repwd.setCustomValidity("再次输入密码不能为空");
        }
       else if(repwd.validity.patternMismatch==true && repwd.val()!==pwd.val()){ 
        	repwd.setCustomValidity("两次输入的密码不一致，必须是6~20位的英文和数字");
        }
        else {
    ...
    $("#registerBtn").mouseover(function(){
        $(this).attr("src","img/register_btn_over.gif");
    }).mouseout(function(){
        $(this).attr("src","img/register_btn_out.gif");
    });
