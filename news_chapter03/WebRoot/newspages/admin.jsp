    ...
    <ul class="classlist">
      ...
      if(list==null){
		  ...
		  for(News tempNew:list){
		    n++;		
	     %> 
	      <li><%=tempNew.getNtitle() %><span> 作者：<%=tempNew.getNauthor() %> &#160;&#160;&#160;&#160; <a href='news_update.jsp?nid=<%=tempNew.getNid()%>'>修改</a> &#160;&#160;&#160;&#160; <a href='../newspages/news_dele.jsp?id=<%=tempNew.getNid()%>' >删除</a> </span> </li>
	      <%if(n%5==0){ %>
	      <li class='space'></li>
	      <%}}}%>
    </ul>
